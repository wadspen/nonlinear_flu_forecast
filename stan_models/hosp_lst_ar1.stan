...
array[HM] real<lower=0, upper=1> ili_ps;                           // all ili data
array[HM] real hosp;
...
vector<lower=0>[n_seasons_hosp] nu;
//real alpha0;
//real alpha1;
//real alpha2;
...
hosp[1] ~ student_t(nu[hosp_seasons[1]], alpha0[hosp_seasons[1]] +
...
for (i in 2:HM) hosp[i] ~ student_t(nu[hosp_seasons[i]], alpha0[hosp_seasons[i]] + 
