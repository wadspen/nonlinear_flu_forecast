...
for parameters of model (\ref{eq:final_hosp}) given observed
...
Occasionally $\{H^{(k)}_{s,w + i}\}^K$ included a small number of negative 
values,
...
section \ref{sec:analysis}, all negative values of $\{H^{(k)}_{s,w + i}\}^K$ 
were 
set to 0 to reflect realistic values of hospitalizations and comply with the 
FluSight forecasting rules.


In the two-stage scheme, the posterior distribution of 
