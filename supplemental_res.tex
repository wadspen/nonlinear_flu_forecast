...
\begin{adjustwidth}{-1.2cm}{-1.5cm}
    ...
    \centering
    \makebox[\linewidth][l]{
    \includegraphics[scale = .54]{Images/wis_cover_sum2.png}
    }
    \end{adjustwidth}
    \caption{a) Averaged over location and horizon weighted interval score
    (WIS) for each week during the season for the 15 models being compared.
...
\begin{adjustwidth}{-1.2cm}{-1.5cm}
    ...
    \centering
    \makebox[\linewidth][l]{
    \includegraphics[scale = .5]{Images/state_and_date_wis2.png}
    }
    \end{adjustwidth}
